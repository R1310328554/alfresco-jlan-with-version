 ...
 * @author gkspencer
 */
public class DBDiskWasDriver implements DiskInterface, DiskSizeInterface, DiskVolumeInterface, NTFSStreamsInterface,
...
//    	  boolean isWord2003 = oldName.toLowerCase().endsWith(".tmp") && oldName.indexOf("~")>-1;
    	  boolean isWord2003 = oldFname.startsWith("~") && oldFname.toLowerCase().endsWith(".tmp");
    	  if(isWord2003)
    	  {
