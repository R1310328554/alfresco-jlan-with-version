...
//	public final static String FileSysTable			= "jweb_JLANFileSys";
...
//	public final static String DataTable			= "jweb_JLANData";
	...
	protected String m_driver = DBUtil.driver;
	
	//	JDBC connection string
	
	protected String m_dsn = DBUtil.url;
	
	//	Username and password
	
	protected String m_userName =DBUtil.username;
	protected String m_password = DBUtil.password;
...
//	protected String m_fileRevisionTable;
...
//	protected DBConnectionPool m_connPool;
	protected static DBConnectionPool m_connPool;
...
//	protected boolean m_sqlDebug;
	...
	protected boolean m_sqlDebug = true;
  ...
  public void initializeDatabase(DBDeviceContext context, ConfigElement params)
    ...
    m_dsn = DBUtil.url;
    m_userName = DBUtil.username;
    m_password = DBUtil.password;
/*    nameVal = params.getChild("DSN");
    ...
    */  
    ...
    //新加表FileRevisionTable
    nameVal = params.getChild("FileRevisionTable");
    if ( nameVal != null)
    	m_fileRevisionTable = nameVal.getValue();
    else
    	m_fileRevisionTable = FileRevisionTable;
...
//	 * @return boolean
//	 */
//	protected final boolean hasFileRevisionTable() {
//	  return m_fileRevisionTable != null ? true : false;
//	}
//	
//	/**
//	 * Return the FileRevision table name
//	 * 
//	 * @return String
//	 */
//	protected final String getFileRevisionTable() {
//		return m_fileRevisionTable;
//	}
//	
//	
//	/**
...
//
  ...
  protected final void setDriverName(String driverClass) {
	...
	protected final void createConnectionPool()
		...
		if(null !=m_connPool && m_connPool.isOnline())
		{
        ...
        for ( int i = 0; i < deleteList.numberOfRequests(); i++) {
          ...
          try {
            ...
            if ( deleteReq.getStreamId() == 0)
              deleteFileRecord( -1, deleteReq.getFileId(), m_dbCtx.isTrashCanEnabled(),null,null,null);
            else
...
//                String sharePath = "";
                String sharePath = DiskUtil.findFristPath(singleReq.getVirtualPath());
                setFileInformation( -1, singleReq.getFileId(), fInfo,sharePath);
