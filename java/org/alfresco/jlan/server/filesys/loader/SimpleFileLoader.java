...
public class SimpleFileLoader implements FileLoader, NamedFileLoader {
  ...
  public int getRequiredDBFeatures() {
	 ...
	 */
	public NetworkFile openFile(FileOpenParams params, int fid, int stid, int did, boolean create, boolean dir,String userName)
   ...
   * @param sess SrvSession
	 ...
	 * @exception IOException
	 */
	public void deleteFile(String fname, int fid, int stid,String shareName)
		throws IOException {
