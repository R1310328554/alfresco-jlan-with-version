...
public class DefaultShareMapper implements ShareMapper, ConfigurationListener {
	...
	public void initializeMapper(ServerConfiguration config, ConfigElement params)
		...
		log4j.debug("\nDSM#initializeMapper ServerConfiguration:"+config+",ConfigElement="+params);
	...
	public SharedDevice findShare(String host, String name, int typ, SrvSession sess, boolean create)
		...
		log4j.debug("\n\n获得目录DSM#findShare SharedDevice findShare name="+name+",host="+host);
	...
	public void deleteShares(SrvSession sess) {
		log4j.debug("\nDSM#deleteShares  SrvSession="+sess);
	...
	public SharedDeviceList getShareList(String host, SrvSession sess, boolean allShares) {
		log4j.debug("\nDSM#getShareList host:"+host+",SrvSession="+sess+" , allShares:"+allShares+" ,m_filesysConfig:"+m_filesysConfig);
...
//		log4j.debug("\n\nDSM#getShareList shrList:"+shrList);
		return shrList;
	}
  ...
  public int configurationChanged(int id, ServerConfiguration config, Object newVal)
    throws InvalidConfigurationException {
	log4j.debug("\nDSM#configurationChanged ServerConfiguration:"+config+",newVal="+newVal+" , id:"+id);
